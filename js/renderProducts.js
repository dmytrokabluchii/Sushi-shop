            ...
            <div class="col-md-6">
                <div class="card mb-4" data-id="${item.id}">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p><small data-items-in-box class="text-muted lng-amountInPortion">${item.portionText}: ${item.itemsInBox} шт.</small></p>
                        <div class="details-wrapper">
                            ...
                            <div class="price">
                                <div class="price__weight">${item.weight} 
                                    <span class="lng-weightPortion">г.</span> 
                                </div>
